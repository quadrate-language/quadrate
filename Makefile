...
STDLIB_MODULES := base64 bits ct flag fmt http io json limits log math mem net tls os sb signal str strconv thread time unicode uri hex bytes crc32 sha256 regex path sort rand uuid testing compress sqlite
