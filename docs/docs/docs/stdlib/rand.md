...
**Signature:** `(rng:ptr arr:ptr len:i64 -- rng:ptr val:i64)`
...
**Signature:** `(rng:ptr lambda:f64 -- rng:ptr n:f64)`
...
**Signature:** `(rng:ptr min:f64 max:f64 -- rng:ptr f:f64)`
...
**Signature:** `(rng:ptr -- rng:ptr f:f64)`
...
**Signature:** `(rng:ptr mean:f64 stddev:f64 -- rng:ptr n:f64)`
...
**Signature:** `(rng:ptr -- rng:ptr n:f64)`
...
**Signature:** `(rng:ptr src:ptr src_len:i64 dst:ptr n:i64 -- rng:ptr)`
...
**Signature:** `(rng:ptr arr:ptr len:i64 -- rng:ptr)`
