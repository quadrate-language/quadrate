...
| `x` | `T` | First value |
| `y` | `i64` | Second value |
| `f` | `fn` | Function for first value (i64 -- i64) |
| `g` | `fn` | Function for second value (i64 -- i64) |
...
| Parameter | Type | Description |
|-----------|------|-------------|
| `x` | `T` | Second element (will have f applied) |
