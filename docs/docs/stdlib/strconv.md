...
<!-- doccheck: page-context use strconv -->
...
- format_bool: Format boolean to string ("true"/"false")
...
Parse string to boolean. Accepts "true"/"1" as true, "false"/"0" as false (case-insensitive).
